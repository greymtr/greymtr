...
to learn scheme and switch over to languages that will allow me to better
explore the functional programming paradigm, which i'm very interested in.

i'm a linux user and a vi novice, consantly trying to grow and get better at
using and creating technology.

i personally believe that software should be sustainable - robust, fast, secure
and easy to maintain while being mindful of resources utilized and minimizing
overall complexity; being able to inspect, modify and redistribute source code
is a basic prerequisite for this.

my other hobbies include electronics, pixel art and literature.

feel free to drop an email - greymtr ( at ) disroot ( dot ) org
